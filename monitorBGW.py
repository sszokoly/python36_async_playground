...
# System
# +---+---------------+-----+--+--------+------------+------+---+---+-----+---+
# |BGW|     LAN IP    |Model|HW|Firmware|  Serial No |Memory|DSP|PSU|Fault|Alm|   
# +---+---------------+-----+--+--------+------------+------+---+---+-----+---*
# |001|192.168.111.111| g430|1A|43.11.12|13TG01116522| 256MB|160|  1|    3|  0|
# +---+---------------+-----+--+--------+------------+------+---+---+-----+---+

# Port
# +---+----+---------+-------+-----+----+----+---------+-------+-----+----+---+
# |BGW|Port| Status  |  Neg  |Speed|Dupl|Port| Status  |  Neg  |Speed|Dupl|Rdn|
# +---+----+---------+-------+-----+----+----+---------+-------+-----+----+---+
# |001|10/5|connected|disable| 100M|half|10/4|connected|disable| 100M|half|5/4|
# +---+----+---------+-------+-----+----+----+---------+-------+-----+----+---+

# Config
# +---+--------+---------------+----+--------+---------------+--------+-------+
# |BGW|rtp-stat|capture-service|snmp| slamon | slamon server |  lldp  |  lsp  |
# +---+- ------+---------------+----+--------+---------------+--------+-------+
...
# Status
# +---+-------------+------------+----------+--------+---------+--------------+
# |BGW|    Uptime   |Act.Session|Tot.Session|Mean Dur|QoS Traps|InUse/Tot. DSP|
# +---+-------------+-----------+-----------+--------+---------+--------------+
# |001|153d05h23m06s|        0/0|    120/120|00:05:17|        2|              |
# +---+-------------+-----------+-----------+--------+---------+--------------+
