...
# +---+--------+--------+---------------+-----+---------------+-----+------+---+
# |BGW|  Start |   End  | Local Address | Port| Remote Address| Port|Status|QoS|
# +---+--------+--------+---------------+-----+---------------+-----+------+---+
# |001|11:09:07|11:11:27|192.168.111.111|55555|100.100.100.100|55555|ended | ✔️|
# +---+--------+--------+---------------+-----+---------------+-----+------+---+

# +---+-----+-------+--------+---------------+---------------+--------+------+
# |BGW|Model|Vintage|Firmware|     LAN IP    |    SLAMon IP  |RTP-Stat|Faults|
# +---+-----+-------+--------+---------------+---------------+--------+------+
# |001| g430|       |43.11.12|192.168.111.111|192.168.111.111| enabled|  none|
# +---+-----+-------+--------+---------------+---------------+--------+------+
